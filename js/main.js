...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const musicData = [
        {
            ...
            "title": "x001",
            "cat": "gym",
            "src": "src/x0/Gym/001_1ecd43b4-0306-4c4a-8662-47031e072c7a.mp3"
        },
        {
            "artist": "Unknown",
            "title": "x003",
        ...
        },
        {
            ...
            "title": "x013",
            "cat": "gym",
            "src": "src/x0/Gym/013_e159bf3a-64ac-4cad-ad31-1d13b42d5e9f.mp3"
        },
        {
            "artist": "Unknown",
            "title": "x019",
    ...
    const tools = [
        {
            ...
            cat: 'network',
            desc: 'Calculate subnet mask, network, broadcast.',
            render: () => `
        ...
        },
        {
            ...
            render: () => `
                ...
                <button class="tool-btn" onclick="textToBin()">TEXT TO BINARY</button>
                <button class="tool-btn" style="margin-top:5px" onclick="binToText()">BINARY TO TEXT</button>
            `
        }
    ];
    ...
    window.calculateIPv4 = () => {
        ...
        if (ip && cidr) {
            document.getElementById('tool-output').innerText = `NETWORK: ${ip}/${cidr} \nMASK: 255.255.255.0 (Simulated)`;
        } else {
            document.getElementById('tool-output').innerText = "INVALID INPUT";
        }
    };
    ...
    window.generatePass = () => {
        ...
        document.getElementById('tool-output').innerText = pass;
    };
    ...
    window.textToBin = () => {
        ...
        document.getElementById('tool-output').innerText = bin;
    };

    window.binToText = () => {
        const bin = document.getElementById('text-input').value;
        const binArray = bin.split(" ");
        let text = "";
        for (let i = 0; i < binArray.length; i++) {
            if (binArray[i]) text += String.fromCharCode(parseInt(binArray[i], 2));
        }
        document.getElementById('tool-output').innerText = text;
    };
